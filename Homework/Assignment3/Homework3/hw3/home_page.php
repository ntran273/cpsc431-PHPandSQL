...
<html>
  ...
  <body>
    ...
    <?php
      ...
      $stmt->execute();
      $stmt->store_result();
      $stmt->bind_result($id, $name_first, $name_last, $street, $city, $state, $country, $zipCode, $avg_game_played, $avg_min, $avg_sec, $avg_points, $avg_assists, $avg_rebounds);
    ?>
                ...
                <td><select name="name_ID" required>
                  ...
                  <?php
                    ...
                    while ($stmt->fetch()) {
                      ...
                      $newPlayer = new Address([$name_first,$name_last]);
