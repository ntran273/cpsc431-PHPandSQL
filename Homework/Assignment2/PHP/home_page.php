...
<html>
  ...
  <body>
    ...
    <!-- Team Roaster Table -->
    <h2 align="center">Team Roaster</h2>
    <?php
        $dataRecords = file('../data/teamroaster.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    ...
    <?php
      $dataRecords = file('../data/statistics.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
      echo "Number of Records:  ".count($dataRecords)."<br/>";
    ?>
    <table style="border:1px solid black; border-collapse:collapse;">
      <tr>
